...
-- Auto reload files (mostly for ssh connections)
vim.o.autoread = true
...
-- Set Default Tabstop / Shiftwidth
...
vim.keymap.set('n', '<leader>q', '<C-w>q', { desc = '[Q]uit current [w]indow' })
...
vim.keymap.set('n', '<A-d>', ':bp|bd! #<CR>', { desc = '[D]elete current buffer' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader><leader>', ':%s/ \\+$//g<enter>', { desc = '[ ] Delete trialing whitespaces' })
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'java', 'python', 'query', 'vim', 'vimdoc' },
